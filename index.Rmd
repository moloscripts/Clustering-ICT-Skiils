...
From the code, the Estimated λ is 0.0295. A small λ will emphasize that the data frame has more numeric variables and it will have a similar results as if k-means was deployed to the data
Whereas λ means that there's a heavy influence of categorical variables in the data. In this case λ inclines more on numeric variables[^4].
...
Our  index is an indication of 'partial agreement of the clusters.
